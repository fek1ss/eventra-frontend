    ...
    <div className={styles.footer}>
      <section className={styles.info}>
        <div className={styles.info__column}>
          ...
          <p className={styles.text}>Your gateway to unforgettable experiences.</p>
        </div>
        <div className={styles.info__column}>
        ...
        <div className={styles.info__column}>
          ...
          <div className={styles.socials}>
            <a href="#" className={styles.text}>Facebook</a>
            <a href="#" className={styles.text}>Twitter</a>
            <a href="#" className={styles.text}>Twitter</a>
          </div>
        </div>
      </section>
      <div className={styles.policy}>
        <p className={styles.text}>© 2025 Eventra. All rights reserved.</p>
      </div>
    </div>
  );
};
